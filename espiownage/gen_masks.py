...
""" Note that we don't care about the actual images. we're just generating
...
def handle_one_file(meta_file_list, # list of all the csv files
    maskdir,                # output directory, where to write mask files to
    ...
    #print("csv_path, mask_path = ",csv_path, mask_path)
