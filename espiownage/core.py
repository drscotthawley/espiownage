...
__all__ = ['mkdir_if_needed', 'meta_to_img_path', 'meta_to_mask_path', 'fix_abangle', 'meta_to_df', 'draw_ellipse',
           'ellipse_to_bbox', 'ring_float_to_class_int', 'crop_to_bb']
...
def crop_to_bb(
    ...
    if coco: right, bottom = bbox[0]+bbox[2], bbox[1]+bbox[3]
    else:    right, bottom = bbox[2], bbox[3]
    return img.crop((bbox[0], bbox[1], right, bottom))  # .crop() is PIL Image.crop()